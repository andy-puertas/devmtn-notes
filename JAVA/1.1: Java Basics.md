...
## Scope
- The contact in which values and expressions are “visible.” Global scope is “visible” to all of your code. There is a hierarchy. Child scope can have access to parent scopes, but not vice versa. 
